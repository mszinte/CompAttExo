function [wPtr]=rgbCheckCalib(wPtr,const,my_key,textExp,button,f)
% ----------------------------------------------------------------------
% [wPtr]=rgbCheckCalib(wPtr,const,my_key,textExp,button)
% ----------------------------------------------------------------------
...
csvwrite(sprintf('%s/Gamma/%s/%i/RGB_Lin/Lin_RedGammaTable_%s_%i.csv',dirC,wPtr.room,wPtr.dist,wPtr.room,wPtr.dist),tabCalibRed);
csvwrite(sprintf('%s/Gamma/%s/%i/RGB_Lin/Lin_GreenGammaTable_%s_%i.csv',dirC,wPtr.room,wPtr.dist,wPtr.room,wPtr.dist),tabCalibGreen);
csvwrite(sprintf('%s/Gamma/%s/%i/RGB_Lin/Lin_BlueGammaTable_%s_%i.csv',dirC,wPtr.room,wPtr.dist,wPtr.room,wPtr.dist),tabCalibBlue);
...
csvwrite(sprintf('%s/Gamma/%s/%i/RGB_Lin/RGB_GammaTabExtPowerFun_%s_%i.csv',dirC,wPtr.room,wPtr.dist,wPtr.room,wPtr.dist),gammaTable);
csvwrite(sprintf('%s/Gamma/%s/%i/RGB_Lin/RGB_ParamFitExtPowerFun_%s_%i.csv',dirC,wPtr.room,wPtr.dist,wPtr.room,wPtr.dist),paramFit);

% Save figure
plot_file= sprintf('%s/Gamma/%s/%i/RGB_Lin/RGB_GammaCurves_%s_%i',dirC,wPtr.room,wPtr.dist,wPtr.room,wPtr.dist);
saveas(f,plot_file);
